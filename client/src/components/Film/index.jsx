  ...
  return (
    <div className="relative block mb-2 w-full xs:ml-2 md:ml-6 md:max-w-[90%] lg:w-full group hover:scale-105 transition duration-500 custom-width ">      
        <img
            alt='background'
            src={img}
            className="h-52 sm:h-52 md:h-44 xl:h-48 brightness-[.45] object-cover group-hover:brightness-25 group-hover:border-l-8 group-hover:border-l-red-500 w-full h-full"
          />
          <div className="absolute top-10 left-3 xs:left-2 sm:left-3 lg:left-9 xs:top-10 sm:top-10 md:top-8 lg:top-10 flex flex-col w-full ">
