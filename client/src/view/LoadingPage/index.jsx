            ...
            <Mylayout>
            {
                ...
                <div className="relative animate-pulse ">
                    <div class="movie--isloading ">
                        <div class="loading-image min-h-[100vh]"></div>
                    </div>
                    <div className="absolute top-20 md:top-[8%] min-w-[100%] min-h-[90vh]">
                        <div class="loading-content bg-neutral-800 h-[90vh] md:grid md:grid-cols-2">
                            <div class=" loading-text-container lg:px-44 lg:py-56 md:px-20 md:py-36 px-10 py-20 flex justify-center md:block">
                                <div class="loading-main-text bg-neutral-700 lg:w-[90%] md:w-[130%] w-[90%] h-20 rounded-lg mb-10"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[150%] md:w-[150%] h-5 mt-5 rounded-lg"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[150%] md:w-[150%] h-5 mt-5 rounded-lg"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[150%] md:w-[150%] h-5 mt-5 rounded-lg"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[150%] md:w-[150%] h-5 mt-5 rounded-lg"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[90%] md:w-[100%] h-5 mt-5 rounded-lg"></div>
                                <div class="hidden md:block bg-neutral-700 lg:w-[60%] md:w-[70%] h-16 mt-5 rounded-lg"></div>
                            </div>
                            <div class="md:hidden bg-neutral-700 w-[50%] h-16 rounded-lg mx-[25%] mb-10"></div>
